...
public class question4 {
    public static void main(String[] args) {
        ...
        // Option 1: Loop across index positions for the first half of the word
        //           and compare the characters at the front and back.
        int len = word.length();
        ...
        // Option 2: Same as 1, but checking the full string start to end
        for (int i = 0; i < len; i++) {
            if (word.charAt(i) != word.charAt(len - 1 - i)) {
                isPalindrome = false;
                break;
        ...
        // Option 3: Track two index positions at once. Very impressive!
        ...
        // Option 4: Use StringBuilder to reverse the string and compare it to
        //           the original. Very impressive.
