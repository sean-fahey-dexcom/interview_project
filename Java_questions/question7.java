...
public class question7 {
    public static void main(String[] args) {
        ...
        // Option 1: Two-pass approach - find max grade first, then collect students
        ...
        // Option 2: Single-pass approach - update list as we find new maximum
        for (Student student : students) {
            if (student.getGrade() > highestGrade) {
                highestGrade = student.getGrade();
                topStudents.clear();
                topStudents.add(student);
            } else if (student.getGrade() == highestGrade) {
                topStudents.add(student);
            }
        }
    }
